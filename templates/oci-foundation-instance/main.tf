module "foundation" {
  source = "../../../../terraform/modules/oci-oke-foundation"
  ...
  control_plane_logging_enabled = var.control_plane_logging_enabled
  vcn_flow_logging_enabled      = var.vcn_flow_logging_enabled
